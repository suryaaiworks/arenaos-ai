...
class CrowdMetricsTracker:
    """
    Accumulates request latency and success telemetry for CrowdAgent.
    """
    def __init__(self):
    ...
    def record_transaction(self, duration: float, success: bool) -> None:
        ...
        logger.debug(f"CrowdMetrics: Processed: {self._total_processed} | Latency: {duration:.4f}s | Success: {success}")
...
crowd_metrics = CrowdMetricsTracker()
