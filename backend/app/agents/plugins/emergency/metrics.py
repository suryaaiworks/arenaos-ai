...
class EmergencyMetricsTracker:
    """
    Accumulates request latency and success telemetry for EmergencyAgent.
    """
    def __init__(self):
    ...
    def record_transaction(self, duration: float, success: bool) -> None:
        ...
        logger.debug(f"EmergencyMetrics: Processed: {self._total_processed} | Latency: {duration:.4f}s | Success: {success}")
...
emergency_metrics = EmergencyMetricsTracker()
